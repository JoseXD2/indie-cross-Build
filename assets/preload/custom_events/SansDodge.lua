...
function onUpdate(elapsed)
    ...
    if DodgeSans == 3 and (getMouseX('camHUD') > 5 and getMouseX('camHUD') < 132) and (getMouseY('camHUD') > 600 and getMouseY('camHUD') < 720 and mouseClicked('left')) or keyJustPressed('z') and not botPlay or Dodge == 3 and Color == 'Orange' and botPlay or DodgeSans == 3 and botPlay and Color == 0 then
