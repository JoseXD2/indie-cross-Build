function onCreate()
    ...
    ShottingStyle = nil -- lua uses nil instead of null 
    ...
    if getProperty('dad.curCharacter') ~= 'Nightmare-Cuphead' then
        ...
        -- cuphead blue shot
        for i = 0, 3 do
            makeAnimatedLuaSprite('Peashoot' ..i, 'cup/bull/Cupheadshoot', getProperty('dad.x') + 400, getProperty('dad.y') - 105 + OffsetY);
...
function onUpdate()
    ...
    if attack == 1 then
        ...
        if BF_CupheadAttacking == false then
            ...
            if (getMouseX('camHUD') > 1150 and getMouseX('camHUD') < 1280) and (getMouseY('camHUD') > 582.5 and getMouseY('camHUD') < 720 and mouseClicked('left')) or keyJustPressed('x') or botPlay and CupheadShotting == true and ShottingStyle ~= 1 then -- If press Shift, BF will attack
