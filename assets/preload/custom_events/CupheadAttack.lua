...
function onUpdate()
    ...
    if Dodge == 2 and (getMouseX('camHUD') > 5 and getMouseX('camHUD') < 132) and (getMouseY('camHUD') > 600 and getMouseY('camHUD') < 720 and mouseClicked('left')) or keyJustPressed('z') and not botPlay or Dodge == 2 and botPlay then
        Dodge = 1;
    end
