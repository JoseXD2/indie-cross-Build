...
function onUpdate(elapsed)
    if DodgeSammy == 3 and (getMouseX('camHUD') > 1150 and getMouseX('camHUD') < 1280) and (getMouseY('camHUD') > 582.5 and getMouseY('camHUD') < 720 and mouseClicked('left')) or keyJustPressed('z') then
        DodgeSammy = 2;
    end
